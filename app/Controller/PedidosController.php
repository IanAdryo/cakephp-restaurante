...
class PedidosController extends AppController{
    ...
    public function view($id = null){
        ...
        if (count($res_pedidos) == 0) {
            ...
            $this->Session->setFlash('Aún no se realizan pedidos', $element = 'default', $params = array('class' => 'alert alert-warning'));
    ...
    public function itemupdate(){
        ...
        if ($this->request->is('ajax')) {
            ...
            $item_update = array( //prepara un arreglo para actualizar la cantidad y el subtotal del elemento $id
    ...
    public function remove()
    {
        ...
        echo json_encode(compact('mostrar_total_remove'));
    ...
    public function quitar() {
        ...
        if ($this->Pedido->deleteAll(1, false)) {
            ...
            $this->Session->setFlash('Todos los pedidos han sido eliminados', $element = 'default', $params = array('class' => 'alert alert-danger'));

        } else {

            $this->Session->setFlash('No se pueden quitar los pedidos', $element = 'default', $params = array('class' => 'alert alert-danger'));
        }
        return $this->redirect(array('controller' => 'platillos', 'action' => 'index'));
        $this->autoRender = false;
    }
    ...
    public function recalcular(){
        ...
        if ($this->request->data['recalcular'] == 'recalcular') {
            ...
            $this->Session->setFlash('Todos los pedidos han sido actualizados', $element = 'default', $params = array('class' => 'alert alert-success'));
