	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Cocinero->save($this->request->data)) {
				$this->Session->setFlash('The cocinero has been saved.', $element = 'default', $params = array('class' => 'alert alert-success'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash('The cocinero could not be saved. Please, try again.', $element = 'default', $params = array('class' => 'alert alert-warning'));
			}
		}
