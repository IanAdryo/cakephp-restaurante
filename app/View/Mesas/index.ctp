			...
			<tbody>
				<?php foreach ($mesas as $mesa) : ?>
					<tr>
						...
						<td class="actions">
							<?php echo $this->Html->link(__('View'), array('action' => 'view', $mesa['Mesa']['id']), array('class' => 'btn btn-md btn-default')); ?>
							<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $mesa['Mesa']['id']), array('class' => 'btn btn-md btn-default')); ?>
							<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $mesa['Mesa']['id']), array('class' => 'btn btn-md btn-default'), array(), __('Are you sure you want to delete # %s?', $mesa['Mesa']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
